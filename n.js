...
var games_cookie_name = "NFL2014",
    ...
    foe_lookup =
    {
        ARI: ['NO', 'CHI', 'SF', 'LA', 'DET', 'PIT', 'BAL', 'CLE', 'SEA', 'CIN', 'SF', 'LA', 'MIN', 'PHI', 'GB', 'SEA'],
        ATL: ['PHI', 'NYG', 'DAL', 'HOU', 'WAS', 'NO', 'TEN', 'TB', 'SF', 'IND', 'MIN', 'TB', 'CAR', 'JAC', 'CAR', 'NO'],
        BAL: ['DEN', 'OAK', 'CIN', 'PIT', 'CLE', 'SF', 'ARI', 'SD', 'JAC', 'LA', 'CLE', 'MIA', 'SEA', 'KC', 'PIT', 'CIN'],
        ...
        CHI: ['GB', 'ARI', 'SEA', 'OAK', 'KC', 'DET', 'MIN', 'SD', 'LA', 'DEN', 'GB', 'SF', 'WAS', 'MIN', 'TB', 'DET'],
        CIN: ['OAK', 'SD', 'BAL', 'KC', 'SEA', 'BUF', 'PIT', 'CLE', 'HOU', 'ARI', 'LA', 'CLE', 'PIT', 'SF', 'DEN', 'BAL'],
        CLE: ['NYJ', 'TEN', 'OAK', 'SD', 'BAL', 'DEN', 'LA', 'ARI', 'CIN', 'PIT', 'BAL', 'CIN', 'SF', 'SEA', 'KC', 'PIT'],
        ...
        DET: ['SD', 'MIN', 'DEN', 'SEA', 'ARI', 'CHI', 'MIN', 'KC', 'GB', 'OAK', 'PHI', 'GB', 'LA', 'NO', 'SF', 'CHI'],
        GB: ['CHI', 'SEA', 'KC', 'SF', 'LA', 'SD', 'DEN', 'CAR', 'DET', 'MIN', 'CHI', 'DET', 'DAL', 'OAK', 'ARI', 'MIN'],
        ...
        MIN: ['SF', 'DET', 'SD', 'DEN', 'KC', 'DET', 'CHI', 'LA', 'OAK', 'GB', 'ATL', 'SEA', 'ARI', 'CHI', 'NYG', 'GB'],
        ...
        PIT: ['NE', 'SF', 'LA', 'BAL', 'SD', 'ARI', 'KC', 'CIN', 'OAK', 'CLE', 'SEA', 'IND', 'CIN', 'DEN', 'BAL', 'CLE'],
        SD: ['DET', 'CIN', 'MIN', 'CLE', 'PIT', 'GB', 'OAK', 'BAL', 'CHI', 'KC', 'JAC', 'DEN', 'KC', 'MIA', 'OAK', 'DEN'],
        SEA: ['LA', 'GB', 'CHI', 'DET', 'CIN', 'CAR', 'SF', 'DAL', 'ARI', 'SF', 'PIT', 'MIN', 'BAL', 'CLE', 'LA', 'ARI'],
        SF: ['MIN', 'PIT', 'ARI', 'GB', 'NYG', 'BAL', 'SEA', 'LA', 'ATL', 'SEA', 'ARI', 'CHI', 'CLE', 'CIN', 'DET', 'LA'],
        LA: ['SEA', 'WAS', 'PIT', 'ARI', 'GB', 'CLE', 'SF', 'MIN', 'CHI', 'BAL', 'CIN', 'ARI', 'DET', 'TB', 'SEA', 'SF'],
        TB: ['TEN', 'NO', 'HOU', 'CAR', 'JAC', 'WAS', 'ATL', 'NYG', 'DAL', 'PHI', 'IND', 'ATL', 'NO', 'LA', 'CHI', 'CAR'],
        TEN: ['TB', 'CLE', 'IND', 'BUF', 'MIA', 'ATL', 'HOU', 'NO', 'CAR', 'JAC', 'OAK', 'JAC', 'NYJ', 'NE', 'HOU', 'IND'],
        WAS: ['MIA', 'LA', 'NYG', 'PHI', 'ATL', 'NYJ', 'TB', 'NE', 'NO', 'CAR', 'NYG', 'DAL', 'CHI', 'BUF', 'PHI', 'DAL']
    },
    foe_hash = {
        ARI: { NO: 1, CHI: 1, SF: 1, LA: 1, DET: 1, PIT: 1, BAL: 1, CLE: 1, SEA: 1, CIN: 1, SF: 1, LA: 1, MIN: 1, PHI: 1, GB: 1, SEA: 1 },
        ATL: { PHI: 1, NYG: 1, DAL: 1, HOU: 1, WAS: 1, NO: 1, TEN: 1, TB: 1, SF: 1, IND: 1, MIN: 1, TB: 1, CAR: 1, JAC: 1, CAR: 1, NO: 1 },
        BAL: { DEN: 1, OAK: 1, CIN: 1, PIT: 1, CLE: 1, SF: 1, ARI: 1, SD: 1, JAC: 1, LA: 1, CLE: 1, MIA: 1, SEA: 1, KC: 1, PIT: 1, CIN: 1 },
        ...
        CHI: { GB: 1, ARI: 1, SEA: 1, OAK: 1, KC: 1, DET: 1, MIN: 1, SD: 1, LA: 1, DEN: 1, GB: 1, SF: 1, WAS: 1, MIN: 1, TB: 1, DET: 1 },
        CIN: { OAK: 1, SD: 1, BAL: 1, KC: 1, SEA: 1, BUF: 1, PIT: 1, CLE: 1, HOU: 1, ARI: 1, LA: 1, CLE: 1, PIT: 1, SF: 1, DEN: 1, BAL: 1 },
        CLE: { NYJ: 1, TEN: 1, OAK: 1, SD: 1, BAL: 1, DEN: 1, LA: 1, ARI: 1, CIN: 1, PIT: 1, BAL: 1, CIN: 1, SF: 1, SEA: 1, KC: 1, PIT: 1 },
        ...
        DET: { SD: 1, MIN: 1, DEN: 1, SEA: 1, ARI: 1, CHI: 1, MIN: 1, KC: 1, GB: 1, OAK: 1, PHI: 1, GB: 1, LA: 1, NO: 1, SF: 1, CHI: 1 },
        GB: { CHI: 1, SEA: 1, KC: 1, SF: 1, LA: 1, SD: 1, DEN: 1, CAR: 1, DET: 1, MIN: 1, CHI: 1, DET: 1, DAL: 1, OAK: 1, ARI: 1, MIN: 1 },
        ...
        MIN: { SF: 1, DET: 1, SD: 1, DEN: 1, KC: 1, DET: 1, CHI: 1, LA: 1, OAK: 1, GB: 1, ATL: 1, SEA: 1, ARI: 1, CHI: 1, NYG: 1, GB: 1 },
        ...
        PIT: { NE: 1, SF: 1, LA: 1, BAL: 1, SD: 1, ARI: 1, KC: 1, CIN: 1, OAK: 1, CLE: 1, SEA: 1, IND: 1, CIN: 1, DEN: 1, BAL: 1, CLE: 1 },
        SD: { DET: 1, CIN: 1, MIN: 1, CLE: 1, PIT: 1, GB: 1, OAK: 1, BAL: 1, CHI: 1, KC: 1, JAC: 1, DEN: 1, KC: 1, MIA: 1, OAK: 1, DEN: 1 },
        SEA: { LA: 1, GB: 1, CHI: 1, DET: 1, CIN: 1, CAR: 1, SF: 1, DAL: 1, ARI: 1, SF: 1, PIT: 1, MIN: 1, BAL: 1, CLE: 1, LA: 1, ARI: 1 },
        SF: { MIN: 1, PIT: 1, ARI: 1, GB: 1, NYG: 1, BAL: 1, SEA: 1, LA: 1, ATL: 1, SEA: 1, ARI: 1, CHI: 1, CLE: 1, CIN: 1, DET: 1, LA: 1 },
        LA: { SEA: 1, WAS: 1, PIT: 1, ARI: 1, GB: 1, CLE: 1, SF: 1, MIN: 1, CHI: 1, BAL: 1, CIN: 1, ARI: 1, DET: 1, TB: 1, SEA: 1, SF: 1 },
        TB: { TEN: 1, NO: 1, HOU: 1, CAR: 1, JAC: 1, WAS: 1, ATL: 1, NYG: 1, DAL: 1, PHI: 1, IND: 1, ATL: 1, NO: 1, LA: 1, CHI: 1, CAR: 1 },
        TEN: { TB: 1, CLE: 1, IND: 1, BUF: 1, MIA: 1, ATL: 1, HOU: 1, NO: 1, CAR: 1, JAC: 1, OAK: 1, JAC: 1, NYJ: 1, NE: 1, HOU: 1, IND: 1 },
        WAS: { MIA: 1, LA: 1, NYG: 1, PHI: 1, ATL: 1, NYJ: 1, TB: 1, NE: 1, NO: 1, CAR: 1, NYG: 1, DAL: 1, CHI: 1, BUF: 1, PHI: 1, DAL: 1 }
    }, unique_foes = 13,
    NFL_teams = ["ARI", "ATL", "BAL", "BUF", "CAR", "CHI", "CIN", "CLE", "DAL", "DEN", "DET", "GB", "HOU", "IND", "JAC", "KC", "MIA", "MIN", "NE", "NO", "NYG", "NYJ", "OAK", "PHI", "PIT", "SD", "SEA", "SF", "LA", "TB", "TEN", "WAS"],
